...
//regije
    ...
    void regionIntoWorld2(Region *region, World *world) {
    ...
    void regionInit2(Region *region, int startY, int startX, int height, int width, char fillCharacter) {
      ...
      void initializeRegions2(World *world, RandomNumbers *numbers) {
...
//doors i hodnjiks
    void doorL2(Region *region, World *world,int index, int brVrata){
    ...
    void doorR2(Region *region, World *world, int index, int brVrata ){
    ...
    void doorT2(Region *region, World *world, int index, int brVrata ){
    ...
    void doorB2(Region *region, World *world, int index, int brVrata ){
    ...
    void initializeDoors2(World *world, Region *region) {
        
        
        //regija 0
        
        doorR2(region, world, 0, 2);
        doorB2(region, world, 0, 3);



        //regija 1
        doorL2(region, world, 1, 0);
        
        doorB2(region, world, 1, 3);

        

         //regija 2
         
         doorT2(region, world, 2, 1);
         doorR2(region, world, 2, 2);


         //regija 3
         doorT2(region, world, 2, 1);
         doorR2(region, world, 3, 2);
         doorB2(region, world, 3, 3);
        


         //regija 4
         doorL2(region, world, 4, 0);
